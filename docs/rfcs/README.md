...
| [0020](0020-nest-lifecycle-and-the-n-1-upgrade.md) | Nest lifecycle and the N-1 upgrade — kill the subgraph resync tax | 0012, 0019, 0018 §1, 0013 §3 | **Accepted** (2026-07-21) — roadmap thread 4; **slices 1 (`nest diff` classifier) + 2a (atomic serving-swap mechanism) shipped**; slices 2b–4 pending |
